...
final class ChangeownershipTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @vcr test_changeownership_sample__invalid_token
     */
    public function testChangeownershipInvalidToken(): void
    {
        $client = new Client([
            'scheme'   => 'https',
        ...
        $response = $client->changeownership();
