...
class AuthFlushTest extends \PHPUnit_Framework_TestCase
{
    /**
     ...
     */
    public function testAuthFlushBasicAuth()
    {
        $client = new Client([
            'scheme'   => 'https',
            'hostname' => 'www.smartcallesb.co.za',
     ...
     */
    public function testAuthFlushAlreadyFlushd()
    {
        $client = new Client([
            'scheme'   => 'https',
            'hostname' => 'www.smartcallesb.co.za',
